  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline justify-center mb-3">
        <span className="text-5xl md:text-6xl font-display font-light text-navy tracking-tight">{value}</span>
        {suffix && <span className="text-2xl font-display font-light text-navy/30 ml-1">{suffix}</span>}
      </div>
